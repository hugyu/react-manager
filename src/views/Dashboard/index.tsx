  ...
  return (
    <div className={styles.dashboard}>
      ...
      <div className={styles.chart}>
        <Card title='订单和流水走势图' extra={<Button type='primary' onClick={renderLineData}>刷新</Button>}>
          <div ref={lineRef} className={styles['item-line']}></div>
        </Card>
      </div>
      <div className={styles.chart}>
        <Card title='司机分布' extra={<Button type='primary' onClick={renderPieData}>刷新</Button>}>
          <div ref={pieRef1} className={styles['item-pie']}></div>
          <div ref={pieRef2} className={styles['item-pie']}></div>
        </Card>
      </div>
      <div className={styles.chart}>
        <Card title='模型诊断' extra={<Button type='primary' onClick={renderRadarData}>刷新</Button>}>
